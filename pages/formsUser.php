                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">                        
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post" action="Users/datosObjetoUser.php" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label>Objeto de Aprendizaje</label>
                                            <input type="file" name="subir" id="file">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="fechaOA"
                                            placeholder="Fecha" name="dateOA" type="date" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <!--obtencion de datos desde el archivo!-->
                                        <script>            
