            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-success">
                    <div class="panel-heading">
                        <h2>PROFESOR</h2>
                        <h3 class="panel-title">Complete los siguientes campos</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" method="post" action="nuevoUsuario.php?user=teacher">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Rol.." name="Rol" type="text" value="Profesor" readonly>
                                </div>                          
